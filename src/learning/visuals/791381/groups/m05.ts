// Learning visuals — TRUSTED GROUP for content module m05 (Phase 8E-6 lazy-loading granularity).
//
...
// (registry.ts) maps each visualId to a literal `import("./791381/groups/m05")` + a literal named export.

export { default as CiscoCliOverview } from "../batch8/CiscoCliOverview";
export { default as ShowCommandsMap } from "../batch8/ShowCommandsMap";
