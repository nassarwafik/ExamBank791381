// Learning visuals — TRUSTED GROUP for content module m18 (Phase 8E-6 lazy-loading granularity).
//
...
// (registry.ts) maps each visualId to a literal `import("./791381/groups/m18")` + a literal named export.

export { default as EncapsulationStack } from "../batch5/EncapsulationStack";
export { default as PduAnatomy } from "../batch5/PduAnatomy";
