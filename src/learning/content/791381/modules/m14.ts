        ...
        // PDF 88 — DNS / HTTP / DHCP
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              title: "مثال محلول: طالب يفتح المتصفح ويكتب google.com — أين يعمل كل بروتوكول؟",
              steps: [
                { text: "قبل كل شيء يحتاج الحاسوب إلى عنوان IP لنفسه: DHCP «يوزّع عناوين IP تلقائيًا على الأجهزة»." },
              ...
              result: "DHCP يمنح الجهاز عنوانه · DNS يجد عنوان الموقع · HTTP يجلب الصفحة",
              explanation: "هذا هو صندوق «معًا» في الكتاب بترتيب الحدوث.",
            },
            {
