        ...
        // PDF 93 — أمر ping
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              steps: [
                { text: "8.8.8.8 عنوان عام على الإنترنت؛ إذا كان جهازك متّصلًا بالإنترنت فسيصل الأمر ويعرض زمن الوصول." },
                { text: "10.255.255.1 من نطاق العناوين الخاصة (تعرفه من وحدة عناوين IP)؛ لا يصل إليه ping إلا إذا وُجد جهاز بهذا العنوان داخل شبكتك." },
                { text: "لذلك عادةً: الأول يصل والثاني لا يصل — ليس لأن الأمر خاطئ، بل لأن الوجهة غير موجودة في شبكتك." },
              ],
              result: "ping 8.8.8.8 يصل (عبر الإنترنت) · ping 10.255.255.1 لا يصل غالبًا (عنوان خاص غير موجود في شبكتك)",
              explanation: "ping يفحص الاتصال «على مستوى الشبكة» فقط، ووجود اتصال يعتمد على وجود الوجهة فعلًا.",
            },
            {
