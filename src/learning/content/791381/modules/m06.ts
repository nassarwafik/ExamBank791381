        ...
        // PDF 229 — امتحانات نهائية للتدريب (QR exams page) + module review
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              spans: [T("الامتحانات النهائية للتدريب الستة يمكن فتحها من داخل المنصة عندما يصبح الجزء المرتبط بها متاحًا (كل امتحان يُحل كتدريب حرّ: تُحفظ أفضل نتيجة فقط ولا يُحسب كواجب)؛ وهنا نختم بمراجعة قصيرة لوحدة "), L("ACL"), T(".")],
            },
