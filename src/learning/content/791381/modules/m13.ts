        ...
        // PDF 84 — TCP و UDP
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              spans: [T("«موثوق» تعني أن المرسل يتأكّد أن البيانات وصلت كاملة وبالترتيب الصحيح، لذلك لا يضيع شيء لكن الأمر يأخذ وقتًا أطول. «سريع» تعني الإرسال دون انتظار التأكيد، لذلك قد يضيع جزء صغير لكن الوقت أقصر.")],
            },
            {
