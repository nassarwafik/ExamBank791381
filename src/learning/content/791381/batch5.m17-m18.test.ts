...
describe("Batch 5 — provenance, RTL/LTR, safety, skeletons and registry consistency", () => {
  ...
  it("historical skeletons m03–m06 are untouched (ids, titles, page ids, PDF mappings) and merely shift to orders 15–18; b3 lists m13 … m18; b4/b6 unchanged", () => {
    ...
    expect(byId["791381-m04"].lessons[0].pages.map(p => [p.id, p.source!.pdfPageStart, p.source!.printedPage])).toEqual([["791381-m04-l01-p01", 148, 146]]);
