...
describe("Phase 2 — content registry (lazy, module-level chunking)", () => {
  ...
  it("loads a course manifest lazily WITHOUT eagerly importing any page/module body, and issues no network request", async () => {
    ...
    // m01, m02 (3B–3D), m07 (3E), m08–m10 (Units 4–6), m11–m12 (Units 7–8), m13 (Batch 3), m14–m16 (Batch 4), m17–m18 (Batch 5), m03 (Batch 6, completed in place), m19 and m04 (Batch 7), m20–m22 (Batch 8), m23–m24 and m05 (Batch 9, m05 completed in place), m25–m27 and m06 (Batch 10, m06 completed in place) and m28 (the final summary) have real bodies — every manifest module.
