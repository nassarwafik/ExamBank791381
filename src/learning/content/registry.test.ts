...
describe("Phase 2 — content registry (lazy, module-level chunking)", () => {
  ...
  it("loads a course manifest lazily WITHOUT eagerly importing any page/module body, and issues no network request", async () => {
    ...
    // m01, m02 (3B–3D), m07 (3E), m08–m10 (Units 4–6), m11–m12 (Units 7–8), m13 (Batch 3), m14–m16 (Batch 4) and m17–m18 (Batch 5) have real bodies; the skeleton modules (m03–m06) do not.
    const REAL = ["791381-m01", "791381-m02", "791381-m07", "791381-m08", "791381-m09", "791381-m10", "791381-m11", "791381-m12", "791381-m13", "791381-m14", "791381-m15", "791381-m16", "791381-m17", "791381-m18"];
